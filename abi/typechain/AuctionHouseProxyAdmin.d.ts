...
interface AuctionHouseProxyAdminInterface extends ethers.utils.Interface {
  functions: {
...
export class AuctionHouseProxyAdmin extends Contract {
  ...
  interface: AuctionHouseProxyAdminInterface;
