...
interface IWizardTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IWizardToken extends Contract {
  ...
  interface: IWizardTokenInterface;
  ...
  callStatic: {
    ...
    setSupply(supply: BigNumberish, overrides?: CallOverrides): Promise<void>;
